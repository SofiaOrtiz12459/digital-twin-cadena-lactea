...
with st.sidebar:
    ...
    page = st.radio("NAVEGACIÓN", ["Dashboard", "Predicciones y viabilidad", "Diseño y optimización", "Transporte y logística", "Escenarios", "Laboratorio DT", "Comparación", "Historial de ciclos", "Lecciones", "Glossary"], index=0)
    st.divider()
...
def render_predictive_center(pkg):
    ...
    st.markdown("### 🔭 Inteligencia predictiva y viabilidad")
...
if page == "Predicciones y viabilidad":
